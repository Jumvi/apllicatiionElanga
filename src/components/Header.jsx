      ...
      <>
        <li className='flex'>
          <NavLink to='/connexion' className='text-lime-400'>
            <button className='rounded w-40 h-10 bg-white outline outline-offset-0 outline-lime-400'>Se connecter</button>
          </NavLink>
        </li>
        <li className='flex items-center'>
          <NavLink to='creationCompte' className='text-black font-semibold flex'>
            <button className='bg-lime-400 text-white w-40 h-10 rounded'>Créer un compte</button>
          </NavLink>
        </li>
      </>
    )}
